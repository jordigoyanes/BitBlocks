//VARIABLES YOU HAVE TO SETUP
var MarketAccountID = 5631204233576448; // must be integer
...
var MarketName = "Market - Priced in bits";
...
var OpenMarket = function(event){
	var addItem = function(item, price){
		...
		if (event.getRightClicked().getType().equals(EntityType.VILLAGER)) {
			...
			addItem(new ItemStack(Material.GOLD_BLOCK,4),17500)
			addItem(new ItemStack(Material.GOLDEN_APPLE,1),50)
			addItem(new ItemStack(Material.ARROW,16),500)
			addItem(new ItemStack(Material.PRISMARINE,16),7500)
